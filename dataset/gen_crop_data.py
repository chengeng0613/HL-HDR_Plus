...
def main():
    ...
    parser.add_argument("--data_root", type=str, default='/sdb/cjw/Datasets/Sig17')
    ...
    cropped_training_data_path = os.path.join(args.data_root,
                                              'sig17_training_crop{}_stride{}_aug'.format(str(args.patch_size),
                                                                                       str(args.stride)))
    ...
    for scene in all_scenes:
        ...
        for data in croped_data:
            ...
            if args.aug:
                ...
                flip_sample_0 = flip_sample(rotate_sample_0, 0)
                save_sample(flip_sample_0, cropped_training_data_path, str(counter).zfill(6))
                counter += 1

                flip_sample_0 = flip_sample(rotate_sample_0, 1)
                save_sample(flip_sample_0, cropped_training_data_path, str(counter).zfill(6))
                counter += 1
                ...
                rotate_sample_2 = rotate_sample(data, 2)
                save_sample(rotate_sample_2, cropped_training_data_path, str(counter).zfill(6))
                counter += 1
