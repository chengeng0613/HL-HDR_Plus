...
def get_args():
    parser = argparse.ArgumentParser(description='HL-HDR',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)

    parser.add_argument("--dataset_dir", type=str, default='/home/data/data/Sig17',
                        help='dataset directory'),
    parser.add_argument('--patch_size', type=int, default=256),
    parser.add_argument("--sub_set", type=str, default='sig17_training_crop256_stride64_aug',
                        help='dataset directory')
    ...
    parser.add_argument('--lr_decay_interval', type=int, default=70,
...
def validation(args, model, device, val_loader, optimizer, epoch, criterion, cur_psnr, accelerator):
    ...
    with open(os.path.join(args.logdir, 'psnr_scconv_drdb_lfe.json'), 'a') as f:
